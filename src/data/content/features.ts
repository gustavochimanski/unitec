...
export const showcaseFeatures: ShowcaseFeature[] = [
  ...
  },
  {
    ...
    imageSrc: "/screenshots/supervisor/roteirizador.jpeg",
    imageAlt: "Roteirizador com mapa, pedidos e motoboys vinculados",
    frame: "desktop",
    icon: Map,
  },
  {
    ...
    imageSrc: "/screenshots/supervisor/whatsapp.jpeg",
    imageAlt: "Inbox de WhatsApp com bot, pedidos e atendimento",
    frame: "desktop",
    icon: MessageCircle,
  },
  {
